...
public class Blackjack1App {
	...
	static public void main (final String[] args) throws IOException {
		...
		final Blackjack1Game game = new Blackjack1Game();
	 ...
	 * @param arguments the arguments
	 */
	static private void processRollCommand (final Blackjack1Game game, final String arguments) {
		try {
			game.rollPlayer();

			final int playerRollCount = game.getPlayerRolls().length;
			System.out.println("You rolled a " + game.getPlayerRolls()[playerRollCount - 1]);
	 ...
	 * @param arguments the arguments
	 */
	static private void processStandCommand (final Blackjack1Game game, final String arguments) {
		try {
			game.rollDealer();
	 ...
	 * @param arguments the arguments
	 */
	static private void processResetCommand (final Blackjack1Game game, final String arguments) {
		game.reset();
